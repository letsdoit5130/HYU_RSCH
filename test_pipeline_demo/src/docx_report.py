"""
test_pipeline_demo Word 비즈니스 보고서 생성 스크립트
...
def build_docx_report():
    ...
    title_run = title.add_run("test_pipeline_demo 종합 비즈니스 보고서")
    ...
    doc.add_paragraph(f"수집된 원시 데이터는 총 {len(df)}건이며, 주요 필드는 id, title, category, author, date, views 등 입니다.")
