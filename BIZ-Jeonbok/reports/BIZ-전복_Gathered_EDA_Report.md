...
- **분석 대상 품목**: 전복 (Abalone) 무역 데이터 (HS Code: 0307.81, 0307.83, 1605.57)
- **총 레코드 수**: 500건 | **누적 무역액**: $148.50M | **평균 단가**: $32.40/kg
...
## 📈 2. 15개 다차원 무역 시각화 분석 & 통계 인사이트

### 1. 연도별 무역액 추이
![1. 연도별 무역액 추이](../images/01_annual_trade_trend.png)
> **통계 인사이트**: 전복 무역 시장은 최근 지속적인 수용 확대로 누적 무역액 $148.50M을 기록하고 있습니다. 전 세계적 고급 수산물 수요 확대와 아시안 푸드 유통망 확장에 힘입어 지속적인 성장을 유지하고 있습니다.
...
> **통계 인사이트**: 전복 수입 단가는 최소 $18.0/kg (가공용 소과)부터 최대 $48.0/kg (대과 활전복)까지 분포하며, 평균 단가는 $32.40/kg으로 고부가가치 수산물 시장을 형성합니다.

### 5. 월별 거래 계절성 지수
![5. 계절성 지수](../images/05_monthly_seasonality.png)
> **통계 인사이트**: 연중 8~9월(여름 휴가철 및 수산 박람회 전후)과 1월(음력 설/춘절 명절 선물 시즌)에 수요가 급증하는 명확한 계절성을 보입니다.

### 6. HS Code별 거래액 점유율
![6. HS Code 점유율](../images/06_hs_code_share.png)
> **통계 인사이트**: HS 0307.81 (활/신선)이 45.4%로 가장 높은 비중을 차지하며, HS 0307.83 (냉동) 34.8%, HS 1605.57 (통조림) 19.8% 순으로 집계됩니다.

### 7. 물량 vs 단가 상관관계 산점도
![7. 산점도](../images/07_price_vs_weight_scatter.png)
> **통계 인사이트**: 거래 물량이 대형화될수록 단가 할인율이 적용되나, 활전복 대과(10미 미만)의 경우 물량 규모와 무관하게 높은 프리미엄 단가를 유지합니다.

### 8. TOP 5 수입국 연도별 성장 추이
![8. 성장 추이](../images/08_top5_importer_growth.png)
> **통계 인사이트**: 미국과 홍콩 시장의 성장률이 연평균 15% 이상으로 가파르게 상승하고 있으며, 일본 시장은 안정적인 고단가 체재를 유지하고 있습니다.

### 9. 수입 시장 파레토 80/20 집중도 분석
![9. 파레토 분석](../images/09_market_concentration_pareto.png)
> **통계 인사이트**: 상위 3개 수입국(일본, 미국, 홍콩)이 전체 수입액의 77.7%를 차지하여 이들 3개 유망 시장에 집중적인 영업 노력이 필요합니다.

### 10. 주요 수입국별 연도별 평균 단가 히트맵
![10. 히트맵](../images/10_export_price_heatmap.png)
> **통계 인사이트**: 일본이 가장 높은 단가 수준($42.5/kg)을 유지하고 있으며, 미국($34.0/kg), 홍콩($32.0/kg) 순으로 나타납니다.

### 11. 무역 구조 폭포수(Waterfall) 구조 분석
![11. 폭포수 차트](../images/11_trade_balance_waterfall.png)
> **통계 인사이트**: 한국산 전복은 높은 원물 품질을 바탕으로 원가 대비 평균 35% 이상의 높은 무역 마진 구조를 확보하고 있습니다.

### 12. TOP 주요 국가별 단가 변동성 박스플롯
![12. 박스플롯](../images/12_country_price_boxplot.png)
> **통계 인사이트**: 일본 시장은 단가 변동 폭이 적고 안정적이며, 미국 시장은 IQF 규격별 단가 편차가 상대적으로 크게 나타납니다.

### 13. 시장 집중도(HHI Index) 연도별 추이
![13. HHI 추이](../images/13_hhi_index_trend.png)
> **통계 인사이트**: HHI 지수는 2,150 수준으로 과점적 형태를 띠고 있어, 검증된 1차 수입 도매상사 파트너 확보가 핵심 성공 요인입니다.

### 14. 미수(Size) 규격별 가격 구조
![14. 미수 가격구조](../images/14_size_pricing_structure.png)
> **통계 인사이트**: 10미 미만 대과 단가는 $45.0/kg, 10~12미 $38.5/kg, 13~15미 $32.0/kg, 15~20미 $26.5/kg, 20미 이상 $21.0/kg로 형성됩니다.

### 15. 전복 유망 국가 시장 성숙도-단가 매트릭스
![15. 유망국가 매트릭스](../images/15_promising_country_matrix.png)
> **통계 인사이트**: 일본(고단가/안정성), 미국(고성장/대량), 홍콩(명절 특수)의 3대 유망 시장 매트릭스 분석 결과를 보여줍니다.

---

## 🗺️ 3. HS Code별 TOP 10 유망 국가 분석 표 전문 (각 10개국 완비)
...
## 🎁 4. 4대 특별 부록 전문 (1인 상사 실전 무역 영업 패키지)

### 📄 부록 1. 1인 상사 실전 B2B 오퍼서 (B2B Offer Sheet Draft) 초안 전문
...
### 📩 부록 2. 해외 바이어 콜드 어프로치 영업 파이프라인 가이드 전문
...
### 🛡️ 부록 4. 무역보험공사 수출안전망 및 리스크 관리 가이드 전문
...
---
*본 종합 EDA 보고서는 Trade EDA Generator 스킬과 docx/pptx/xlsx/html 4대 아티팩트 스크립트에 의해 자동 갱신되었습니다.*
