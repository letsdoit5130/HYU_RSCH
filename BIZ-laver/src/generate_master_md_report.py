"""
1인 무역회사를 위한 마른김(HS 121221) 및 조미김(HS 200899) 품목별 구체적 수출 전략을
100% 완전 수록하여 마크다운 정본 보고서를 생성하는 스크립트.
"""
...
OUTPUT_MD_PATH = 'BIZ-laver/reports/HaeYu_Laver_Export_Master_Market_Expansion_Report.md'

content = """# 🚀 [마스터 전략서] 해유 김 수출 종합 EDA 데이터 분석 및 1인 무역회사 글로벌 시장 개척 마스터 보고서
...
print(f"품목별 1인 무역회사 구체적 전략이 100% 반영된 마크다운 보고서가 {OUTPUT_MD_PATH}에 저장되었습니다.")
